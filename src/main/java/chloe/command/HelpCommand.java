...
public class HelpCommand extends Command {
    ...
    public void execute(TaskList tasks, Ui ui, Storage storage) {
        ui.showLine(
                ...
                "",
                "  find KEYWORD",
                "    - Finds tasks whose description contains KEYWORD as a substring",
                "    - e.g., find a (matches tasks containing 'a' anywhere in the description)",
                "    - Please ensure that the tasks are detailed enough so that you can find the task you might want.",
                "",
                "  mark INDEX [INDEXES]",
                "    - Marks one or more tasks as done",
                "     - Indexes refer to the task positions shown by 'list'",
                "    - e.g., mark 2 3",
                "",
